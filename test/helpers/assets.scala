...
class assets extends org.scalatest.FunSuite {
	...
	test("Images: apply args") {
		val result = img("test.png", 'border -> 0)
		assert(result.body === """<img src="/img/test.png" border="0">""")
	}

	test("Images: apply alt & args") {
		val result = img("test.png", "alt test", 'border -> 0)
		assert(result.body === """<img src="/img/test.png" alt="alt test" border="0">""")
	}
